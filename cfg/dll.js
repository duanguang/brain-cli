(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../libs/settings/EConfig", "../libs/settings/WebpackDllManifest"], factory);
    }
    ...
    if (isVendorExist) {
        ...
        module.exports = {
            ...
            output: Object.assign({}, Object.assign({}, output, options.output), { path: distPath, 
