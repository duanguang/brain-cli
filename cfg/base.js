...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "path", "../libs/settings/EConfig", "../libs/constants/constants", "webpack", "../libs/webpack/plugins/htmlWebpackPlugin", "../libs/utils/env", "../libs/webpack/plugins/LegionExtractStaticFilePlugin", "../libs/webpack/entries/getEntries", "../libs/webpack/javaScriptLoader", "../libs/webpack/happy-pack-conf"], factory);
    }
    ...
    function getBaseConfig({ name, devServer, imageInLineSize, defaultPort, publicPath, apps, server, babel, webpack: webpackConfig, htmlWebpackPlugin, projectType, isTslint, }) {
        ...
        publicPath += name + '/';
        const { disableReactHotLoader, commonsChunkPlugin, plugins, tsCompilePlugin, output, } = webpackConfig;
        ...
        function getCssLoaders() {
            ...
            function generateLoaders(cssModule, loader, currLoader) {
        ...
        const config = {
          ...
          事实上 webpack 并不在全局命名空间下运行，但是 CommonsChunkPlugin 这样的插件会使用异步 JSONP 的方法按需加载代码块。插件会注册一个全局的函数叫 window.webpackJsonp，所以同一个页面上运行多个源自不同 webpack 打包出来的代码时，可能会引起冲突。
            ...
            resolve: Object.assign({}, webpackConfig.resolve, { extensions: ['.web.js', '.js', '.json', '.ts', '.tsx', '.jsx'], 
        ...
        if (__DEV__) {
            config.devServer = Object.assign({}, serverProps, { stats: { colors: true }, contentBase: [`./${constants_1.WORKING_DIRECTORY}/`], historyApiFallback: {
                    rewrites: apps.map((app) => ({
                        from: constants_1.HISTORY_REWRITE_FALL_BACK_REGEX_FUNC(app),
                        to: `${publicPath}/${app}/index.html`,
                    })),
                }, headers: Object.assign({ 'Access-Control-Allow-Origin': '*' }, headers), hot: true, port: defaultPort, publicPath: publicPath, noInfo: noInfo, proxy: proxy, inline: false, before: function (app) {
