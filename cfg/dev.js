(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./helpers", "../libs/settings/WebpackDllManifest", "./base", "../libs/settings/EConfig", "./dllPlugins"], factory);
    }
    ...
    const { vendors, customDll, dllCompileParam } = dllConfig;
    dllConfig;
        ...
        config.pendings = [
            () => {
                ...
                Object.keys(dllPlugins_1.DllPlugins).forEach((keys) => {
                    ...
                    const filepath = WebpackDllManifest_1.default.getInstance().resolveManifestPath(keys, WebpackDllManifest_1.default.getInstance().getDllPluginsHash(vendorsDll));
                    if (filepath) {
