 ...
 * @Last Modified time: 2018-08-12 11:28:57
 */
            ...
            <div className={styles.design}>
              <div className={styles.cate}>
                ...
                <div className={styles.cover}>
                  <img src={require("../../public/images/home/Interactive-D.png")} />
                </div>
              </div>
              <div className={styles.cate}>
                <div className={styles.cover}>
              ...
              <div className={styles.cate}>
                <div className={styles.cover}>
                  <img src={require("../../public/images/home/Front-end-E.png")} />
                </div>
                <div className={styles.transform}>
              ...
              <div className={styles.cate}>
                <div className={styles.cover}>
                  <img src={require("../../public/images/home/Backend-E.png")} />
                </div>
                <div className={styles.transform}>
          ...
          <section className={styles.content}>
            ...
            <div className={styles.project}>
              ...
              >
                ...
                <div className={styles.intro}>
                  <img src={require("../../public/images/home/Sketch Library.png")} />
                  <div className={styles["intro-content"]}>
